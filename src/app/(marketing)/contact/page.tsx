    ...
    <>
      ...
      <section className="flex flex-col items-center text-center pt-28 pb-10">
        ...
        <p className="text-lg text-gray-600 mt-4 max-w-2xl">
          Have questions? We’re here to help! Contact us for inquiries, support,
          or collaborations.
        </p>
      </section>
        ...
        <div className="bg-white/60 backdrop-blur-lg p-8 rounded-2xl shadow-2xl border border-white/40">
          ...
          <form className="mt-6 flex flex-col space-y-4">
            <input
              ...
              className="w-full p-3 rounded-lg bg-gray-100 border border-gray-300 focus:outline-[#34C0FC]"
            />
            <input
              type="email"
